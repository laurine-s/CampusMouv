 ...
 */
final class Version20250818131719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lieu (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, rue VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, ville_id INT NOT NULL, campus_id INT DEFAULT NULL, INDEX IDX_2F577D59A73F0036 (ville_id), INDEX IDX_2F577D59AF5D55E1 (campus_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE sortie (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, date_heure_debut DATETIME NOT NULL, duree INT NOT NULL, date_limite_inscription DATETIME NOT NULL, nb_inscription_max INT DEFAULT NULL, nb_inscription_min INT DEFAULT NULL, nb_inscrits INT NOT NULL, infos LONGTEXT NOT NULL, photo VARCHAR(255) DEFAULT NULL, etat VARCHAR(255) NOT NULL, date_heure_fin DATETIME NOT NULL, archived TINYINT(1) DEFAULT 0 NOT NULL, campus_id INT NOT NULL, interets_id INT DEFAULT NULL, organisateur_id INT NOT NULL, lieu_id INT NOT NULL, INDEX IDX_3C3FD3F2AF5D55E1 (campus_id), INDEX IDX_3C3FD3F275621B20 (interets_id), INDEX IDX_3C3FD3F2D936B2FA (organisateur_id), INDEX IDX_3C3FD3F26AB213CC (lieu_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, bio LONGTEXT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, pseudo VARCHAR(180) DEFAULT NULL, campus_id INT DEFAULT NULL, promo_id INT DEFAULT NULL, INDEX IDX_8D93D649AF5D55E1 (campus_id), INDEX IDX_8D93D649D0C07AFF (promo_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_IDENTIFIER_PSEUDO (pseudo), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE lieu ADD CONSTRAINT FK_2F577D59AF5D55E1 FOREIGN KEY (campus_id) REFERENCES campus (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lieu DROP FOREIGN KEY FK_2F577D59AF5D55E1');
