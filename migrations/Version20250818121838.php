 ...
 */
final class Version20250818121838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, bio LONGTEXT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, pseudo VARCHAR(100) DEFAULT NULL, slug VARCHAR(150) NOT NULL, campus_id INT DEFAULT NULL, promo_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649989D9B62 (slug), INDEX IDX_8D93D649AF5D55E1 (campus_id), INDEX IDX_8D93D649D0C07AFF (promo_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_IDENTIFIER_PSEUDO (pseudo), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
